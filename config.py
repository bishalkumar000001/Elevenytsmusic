...
class Config:
    def __init__(self):
        ...
        # Images
        self.DEFAULT_THUMB: str = getenv("DEFAULT_THUMB", "https://envs.sh/a3O.jpg")
        self.PING_IMG: str = getenv("PING_IMG", "https://envs.sh/a3O.jpg")
        self.START_IMG: str = getenv("START_IMG", "https://envs.sh/a3O.jpg")
        self.RADIO_IMG: str = getenv("RADIO_IMG", "https://envs.sh/a3O.jpg")
